...
public class AvatarManager : MonoBehaviour
{
    ...
    [SerializeField] private RawImage _avatar2;
    ...
    public void SetSavedPicture()
    {
        if (PlayerPrefs.HasKey("AvatarPath"))
        {
            ...
            _avatar2.texture = NativeGallery.LoadImageAtPath(path, maxSize);
        }
        else
        {
            _avatar.texture = _basicAvatar;
            _avatar2.texture = _basicAvatar;
        }
    }
